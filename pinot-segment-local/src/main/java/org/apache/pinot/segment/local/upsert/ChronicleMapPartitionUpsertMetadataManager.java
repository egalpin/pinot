...
/**
 * Implementation of {@link PartitionUpsertMetadataManager} that is backed by a {@link ChronicleMap}.
 */
@SuppressWarnings({"rawtypes", "unchecked"})
@ThreadSafe
public class ChronicleMapPartitionUpsertMetadataManager extends BasePartitionUpsertMetadataManager {

  @VisibleForTesting
  final ChronicleMap<ByteArray, RecordLocation> _primaryKeyToRecordLocationMap;

  // Reused for reading previous record during partial upsert
  private final GenericRow _reuse = new GenericRow();

  public ChronicleMapPartitionUpsertMetadataManager(String tableNameWithType, int partitionId,
    ...
    _primaryKeyToRecordLocationMap = ChronicleMap
        .of(ByteArray.class, RecordLocation.class)
        .name("_primaryKeyToRecordLocationMap")
        .entries(4_000_000_000L)
